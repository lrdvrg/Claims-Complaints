...
namespace Propietaria.Controllers
{
    public class ReclaimsResponsesController : Controller
    {
        ...
        // GET: ReclaimsResponses/Details/5
        ...
        {
            reclaim.IdStatus = (from e in db.ReclaimsAndComplaintsStatus where e.description == "Respondida" select e.IdReclaimsAndComplaintsStatus).First();
            ...
            return View("../Reclaims/Index", reclaim);
        }

        // GET: ReclaimsResponses/Delete/5
        ...
        // POST: ReclaimsResponses/Delete/5
